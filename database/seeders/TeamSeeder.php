...
class TeamSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $teams = [
            ...
            ['name' => 'Juventus', 'short_name' => 'JUV', 'serie_a_team' => true, 'tier' => 1],
            ...
            ['name' => 'Udinese', 'short_name' => 'UDI', 'serie_a_team' => true, 'tier' => 3],
            ...
            ['name' => 'Lecce', 'short_name' => 'LEC', 'serie_a_team' => true, 'tier' => 5],
            ['name' => 'Empoli', 'short_name' => 'EMP', 'serie_a_team' => true, 'tier' => 5],
            ['name' => 'Venezia', 'short_name' => 'VEN', 'serie_a_team' => true, 'tier' => 5],
            ['name' => 'Monza', 'short_name' => 'MON', 'serie_a_team' => true, 'tier' => 5],
        ];
